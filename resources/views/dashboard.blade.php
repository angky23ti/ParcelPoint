...
<div class="row">
   ...
   <div class="col-md-12 col-lg-4">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-3 grid-cols-2 ">
              ...
              <div class="text-center">
                  <img src="{{ url('../assets/images/settings/dark/13.png') }}" alt="transparent" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                  <img src="{{ url('../assets/images/settings/light/13.png') }}" alt="transparent" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
    ...
    <!-- fslightbox Script -->
    <script src="{{ url('../assets/js/plugins/fslightbox.js') }}"></script>

    <!-- Settings Script -->
    <script src="{{ url('../assets/js/plugins/setting.js') }}"></script>

    <!-- Slider-tab Script -->
    <script src="{{ url('../assets/js/plugins/slider-tabs.js') }}"></script>

    <!-- Form Wizard Script -->
    <script src="{{ url('../assets/js/plugins/form-wizard.js') }}"></script>

    <!-- AOS Animation Plugin-->
    <script src="{{ url('../assets/vendor/aos/dist/aos.js') }}"></script>

    <!-- App Script -->
    <script src="{{ url('../assets/js/hope-ui.js') }}" defer></script>
