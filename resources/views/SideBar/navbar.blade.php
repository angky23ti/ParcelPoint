...
<head>
  ...
  <link rel="shortcut icon" type="image/svg+xml" href="..\modern/src/assets/images/logos/Ujify-LogoOnly.svg" style="height: 10px;
        width: 10px;"/> <!-- Masih tidak mau bekerja -->
    ...
    <div class="sidebar-content">
      ...
      <nav class="sidebar-nav mt-4">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/ujian" aria-expanded="false">
