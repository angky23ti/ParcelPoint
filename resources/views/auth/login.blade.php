<x-guest-layout>
    <div class="w-full p-8 sm:p-12 md:p-16">
        <div class="text-center mb-10">
            ...
            <p class="text-sm sm:text-base md:text-lg" style="color: #003366; margin-top: 0.5rem;">Masuk untuk memulai ujian</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" class="w-full p-3 mt-1 border rounded bg-green-100 text-sm sm:text-base md:text-lg" required autofocus>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4 flex items-center">
                ...
                <label for="remember_me" class="text-sm sm:text-base md:text-lg" style="color: #003366;">Ingat saya</label>
            </div>
            <div class="mb-4">
